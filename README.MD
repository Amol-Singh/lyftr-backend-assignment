...
This project is a containerized FastAPI-based backend that securely handles webhook events, prevents duplicate processing, and provides useful analytics along with health checks and metrics.
